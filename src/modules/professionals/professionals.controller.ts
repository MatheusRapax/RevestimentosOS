...
export class ProfessionalsController {
  ...
  async inviteProfessional(
    ...
    return this.professionalsService.inviteProfessional(
      clinicId,
      currentUserId,
      dto,
    );
  ...
  async activateProfessional(
    ...
    const clinicId = req.clinicId;
    const currentUserId = req.user?.id;
    return this.professionalsService.activateProfessional(
      clinicId,
      userId,
      currentUserId,
    );
  ...
  async deactivateProfessional(
    ...
    const clinicId = req.clinicId;
    const currentUserId = req.user?.id;
    return this.professionalsService.deactivateProfessional(
      clinicId,
      userId,
      currentUserId,
    );
  ...
  async updateUserRole(
    ...
    const clinicId = req.clinicId;
    const currentUserId = req.user?.id;
    return this.professionalsService.updateUserRole(
      clinicId,
      userId,
      body.roleId,
  ...
  async removeProfessional(
    ...
    const clinicId = req.clinicId;
    const currentUserId = req.user.id;
    return this.professionalsService.removeProfessional(
      clinicId,
      userId,
      currentUserId,
    );
  ...
  @Permissions(PERMISSIONS.PROFESSIONAL_READ)
  async getWorkingHours(@Request() req: any, @Param('userId') userId: string) {
    const clinicId = req.clinicId;
  ...
  async updateWorkingHours(
    ...
    const clinicId = req.clinicId;
    const currentUserId = req.user?.id;
    return this.professionalsService.updateWorkingHours(
      clinicId,
      userId,
      currentUserId,
      hours,
