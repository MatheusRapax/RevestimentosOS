...
import {
  ...
  CreateStockExitDto,
  AddStockExitItemDto,
  UpdateStockExitItemDto,
} from './stock-exit.service';
...
export class StockExitController {
  ...
  updateItem(
    ...
    @Body() dto: UpdateStockExitItemDto,
  ) {
  ...
  @Delete(':id')
  deleteExit(@Request() req: any, @Param('id') id: string) {
    return this.service.deleteExit(req.clinicId, id);
  }
